...
urlpatterns = [
    ...
    path('user/relogin', userviews.relogin),
    ...
    path('board/views', boardviews.view),
    ...
    path('board/deletealert', boardviews.deletealert),
    path('board/search', boardviews.search),
    path('board/searchlist', boardviews.searchlist),
]
